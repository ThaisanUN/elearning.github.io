...
<section id="mu-slider">
    ...
    <div class="mu-slider-single">
      ...
      <div class="mu-slider-content">
        ...
        <p>Learning is the beginning of wealth. Learning is the beginning of health. Learning is the beginning of spirituality. Searching and learning is where the miracle process all begins.</p>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area">
            ...
            <div class="mu-service-single">
              ...
              <h3>Learn Online</h3>
              <p>“Students do not learn much just sitting in classes listening to teachers, and spitting out answers. They must talk about what they are learning.”</p>
            </div>
            <!-- Start single service -->
            <!-- Start single service -->
            <div class="mu-service-single">
              ...
              <p>“One book, one pen, one child and one teacher can change the world. eLearning shouldn’t be a casual joy ride on a Sunday afternoon with the cruise control engaged.”</p>
            </div>
            <!-- Start single service -->
            <!-- Start single service -->
            <div class="mu-service-single">
              <span class="fa fa-table"></span>
              <h3>Best E-learning</h3>
              <p>“Let’s show them it doesn’t have to be like that! The most important principle for designing lively eLearning is to see eLearning design not as information design but the experience.” </p>
            </div>
            <!-- Start single service -->
          </div>
        </div>
