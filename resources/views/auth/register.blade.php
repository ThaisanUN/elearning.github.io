            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="qoute" class="col-md-4 col-form-label text-md-right">Your Qute</label>

                            <div class="col-md-6">
                                <input id="qoute" type="qoute" class="form-control @error('qoute') is-invalid @enderror" name="qoute" value="{{ old('qoute') }}" autocomplete="qoute">
